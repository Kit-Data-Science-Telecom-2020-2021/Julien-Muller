...
def extract_data(data):
    ...
    for elem in list_of_cities:
        dict_city = {
             'name': elem,
             'country': data[elem]["metadata"]["country"],
             'date': data[elem]["weather_list"][0]["dt_txt"],
             'temp': int(data[elem]["weather_list"][1]["main"]["temp"])-273
                     }
        list_of_dict.append(dict_city)
    return list_of_dict

#def corection_extract_data()
